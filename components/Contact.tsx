  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        ...
        <a href="dineshsetti323@gmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/DineshSetti" />
        <SocialLink title="Youtube" link="" />
        <SocialLink
          title="Linkedin"
          link="https://www.linkedin.com/in/dineshsetti"
        />
        <SocialLink
          title="Facebook"
          link="https://www.facebook.com/dineshnaidu.setti"
        />
